...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
	...
	public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
		...
		Drawable arrowD = getResources()
				.getDrawable(R.drawable.wchat_pulltorefresh_indicator_arrow);
		...
		switch (mode) {
		case PULL_FROM_END:
			inAnimResId = R.anim.wchat_pulltorefresh_slide_in_from_bottom;
			outAnimResId = R.anim.wchat_pulltorefresh_slide_out_to_bottom;
		...
		case PULL_FROM_START:
			inAnimResId = R.anim.wchat_pulltorefresh_slide_in_from_top;
			outAnimResId = R.anim.wchat_pulltorefresh_slide_out_to_top;

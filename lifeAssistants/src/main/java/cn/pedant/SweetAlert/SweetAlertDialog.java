...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
	...
	public SweetAlertDialog(Context context, int alertType) {
		...
		mErrorInAnim = OptAnimationLoader.loadAnimation(getContext(),
				R.anim.sweetalert_error_frame_in);
		mErrorXInAnim = (AnimationSet) OptAnimationLoader.loadAnimation(
				getContext(), R.anim.sweetalert_error_x_in);
		...
		mSuccessBowAnim = OptAnimationLoader.loadAnimation(getContext(),
				R.anim.sweetalert_success_bow_roate);
		mSuccessLayoutAnimSet = (AnimationSet) OptAnimationLoader
				.loadAnimation(getContext(), R.anim.sweetalert_success_mask_layout);
		mModalInAnim = (AnimationSet) OptAnimationLoader.loadAnimation(
				getContext(), R.anim.sweetalert_modal_in);
		mModalOutAnim = (AnimationSet) OptAnimationLoader.loadAnimation(
				getContext(), R.anim.sweetalert_modal_out);
	...
	private void changeAlertType(int alertType, boolean fromCreate) {
		...
		if (mDialogView != null) {
			...
			case WARNING_TYPE:
				mConfirmButton
						.setBackgroundResource(R.drawable.sweetalert_red_button_background);
